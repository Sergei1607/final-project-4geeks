	...
	return {
		...
		actions: {
			...
			loadSomedata: () => {
				...
				fetch("https://3001-white-guanaco-4cowgqvv.ws-us04.gitpod.io/api/get_caninos", requestOptions)
				...
				fetch("https://3001-white-guanaco-4cowgqvv.ws-us04.gitpod.io/api/pet", requestOptions)
					.then(response => response.json())
